...
class SearchEngine {
     ...
     */
    findCounterpart(sourceDb, targetDb, uuid) {
        ...
        const serializedSource = serializeEntry(sourceEntry, { maskPasswords: false });
        ...
        if (counterpart) {
            return {
                ...
                counterpart: serializeEntry(counterpart, { maskPasswords: false }),
                matchMethod: 'uuid'
            };
        }
